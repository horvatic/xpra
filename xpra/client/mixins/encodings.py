...
class Encodings(StubClientMixin):
    ...
    def parse_server_capabilities(self):
        ...
        self.server_encodings_problematic = c.strlistget("encodings.problematic", ())
    ...
    def get_encodings(self):
        ...
        if ("rgb24" in cenc or "rgb32" in cenc) and "rgb" not in cenc:
            cenc.append("rgb")
        return [x for x in cenc if x not in ("rgb32", "rgb24")]
    ...
    def do_get_core_encodings(self):
        ...
        core_encodings = [x for x in core_encodings if x in self.allowed_encodings]
